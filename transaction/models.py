...
class CashIn(models.Model):
    ...
    sender_id_or_passport = models.CharField(max_length=350,default='-',null = True, verbose_name= "Sender ID or Passport ")
    ...
    recipient_id_or_passport = models.CharField(max_length=350,default='-',null = True, verbose_name= "ID or Passport ")
    comment = models.TextField(max_length=200,null=True, blank=True,verbose_name= "Comment")
    distribution = models.JSONField(default=default_json_value)
